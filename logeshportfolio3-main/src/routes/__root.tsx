...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Full Stack Developer, AI Engineer, Prompt Engineer, LLM Engineer, Machine Learning, Portfolio, React Developer" },
      ...
      { name: "twitter:title", content: "Logesh M | Full Stack Developer | AI Prompt Engineer | LLM Engineer" },
      { name: "twitter:description", content: "Portfolio of Logesh M showcasing projects, AI expertise, web development skills, and aspirations in Large Language Models." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1c894c0d-0c9c-44fe-8b01-70588d06daa4/id-preview-6d363bfd--f468bc78-2758-40b9-8e30-3b0c3e2085e9.lovable.app-1781675179265.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1c894c0d-0c9c-44fe-8b01-70588d06daa4/id-preview-6d363bfd--f468bc78-2758-40b9-8e30-3b0c3e2085e9.lovable.app-1781675179265.png" },
    ],
    links: [
